...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  const routes = [
    ...
    { path: "/gradinita-privata-popesti-leordeni", changeFrequency: "monthly" as const, priority: 0.8 },
    { path: "/cresa-privata-popesti-leordeni", changeFrequency: "monthly" as const, priority: 0.8 },
    { path: "/tabere-excursii-copii-popesti-leordeni", changeFrequency: "monthly" as const, priority: 0.8 },
